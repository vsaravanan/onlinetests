...
import {findmaxslice} from 'components/onlinetests';
      ...
      <>
        ...
        <div>
          ...
          <ul  >
            ...
            <li> 
               findmaxslice([-2, -3, 4, -1, -2, 1, 5, -3]) =>
               <span className='findmaxslice'> { findmaxslice([-2, -3, 4, -1, -2, 1, 5, -3])}  
               </span>
            </li>
        ...
        <div>
          ...
          <ul >
            ...
            <li className='findmaxslice' > findmaxslice => { findmaxslice()}  </li>
